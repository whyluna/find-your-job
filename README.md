...
<p align="center">
  <a href="https://github.com/whyluna/find-your-job/releases/tag/v0.1.2">下载 v0.1.2</a>
  ·
...
1. 从 [v0.1.2 Release](https://github.com/whyluna/find-your-job/releases/tag/v0.1.2) 下载 `FindYourJob_0.1.2_aarch64.dmg`。
...
v0.1.2 扩展采用浏览器侧边栏，需要 Chrome / Edge 116 或更高版本。请同步升级到本次 Release 中的 App 和扩展：新版侧边栏的后台 AI 解析任务需要 App v0.1.2；新版 App 仍兼容旧扩展的同步解析接口。
...
1. 从 [v0.1.2 Release](https://github.com/whyluna/find-your-job/releases/tag/v0.1.2) 下载 `FindYourJob-browser-extension-v0.1.2.zip`。
