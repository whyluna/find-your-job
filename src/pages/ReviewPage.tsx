                          ...
                          <div className="mt-2 flex flex-wrap gap-1">
                            {q.tags.map((t) => (
                              <button
                                ...
                                className="rounded-md bg-slate-100 px-1.5 py-0.5 text-[10px] text-slate-500 hover:bg-indigo-50 hover:text-indigo-600 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-indigo-900/30 dark:hover:text-indigo-300"
                              >
                                {t}
                              </button>
                            ))}
